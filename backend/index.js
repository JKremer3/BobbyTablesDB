...
app.get('/businesses/:userid/:zip', db.getBusinessesInZip)
...
app.post('/tip/:busid/:userid/:tipdate/:tiptime', db.putLikeTip)
...
app.get('/business/openClose/:busid/:day', db.getBusOpenClose)
